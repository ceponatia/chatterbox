...
- Speech patterns and voice
  - [rhythm, pacing, sentence structure]
  - [intonation, verbal tics, catchphrases]
  - [humor style, directness level]
- Vocabulary & word choice
  - [register, slang level, characteristic phrases]
- Mannerisms & physical beats
  - [facial expressions, body language habits]
  - [gestures, posture, physical tics]
- Interaction style
  - [how {{ char }} engages with others, humor style, flirtation level]
- Look/Presence
  - [build, height, notable physical features]
  - [overall vibe, energy, how they carry themselves]
- Outfit
  - [current clothing, accessories, overall style]
- Hairstyle
  - [hair color, length, style]
- Voice description (sound)
  - [pitch, texture, notable qualities]
  - [dynamics, articulation, overall vocal vibe]

### Background and relationship to the player

- [shared history, how {{ char }} and {{ user }} know each other, current dynamic]
- Initial relationship status: [{{ char }}'s current relationship situation, if any]
